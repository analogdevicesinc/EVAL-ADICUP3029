...
C_SRCS += \
../skeleton/arrow/net.c \
../skeleton/arrow/storage.c 

SRC_OBJS += \
./skeleton/arrow/net.o \
./skeleton/arrow/storage.o 

C_DEPS += \
./skeleton/arrow/net.d \
./skeleton/arrow/storage.d 


# Each subdirectory must supply rules for building sources it contributes
skeleton/arrow/%.o: ../skeleton/arrow/%.c
	@echo 'Building file: $<'
