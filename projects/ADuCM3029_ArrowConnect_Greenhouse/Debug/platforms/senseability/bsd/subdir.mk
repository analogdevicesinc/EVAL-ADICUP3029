...
C_SRCS += \
../platforms/senseability/bsd/socket.c 

SRC_OBJS += \
./platforms/senseability/bsd/socket.o 

C_DEPS += \
./platforms/senseability/bsd/socket.d 


# Each subdirectory must supply rules for building sources it contributes
platforms/senseability/bsd/%.o: ../platforms/senseability/bsd/%.c
	@echo 'Building file: $<'
