...
C_SRCS += \
../platforms/senseability/arrow/net.c \
../platforms/senseability/arrow/storage.c 

SRC_OBJS += \
./platforms/senseability/arrow/net.o \
./platforms/senseability/arrow/storage.o 

C_DEPS += \
./platforms/senseability/arrow/net.d \
./platforms/senseability/arrow/storage.d 


# Each subdirectory must supply rules for building sources it contributes
platforms/senseability/arrow/%.o: ../platforms/senseability/arrow/%.c
	@echo 'Building file: $<'
