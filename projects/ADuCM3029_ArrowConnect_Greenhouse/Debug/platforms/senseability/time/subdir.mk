...
C_SRCS += \
../platforms/senseability/time/_time.c 

SRC_OBJS += \
./platforms/senseability/time/_time.o 

C_DEPS += \
./platforms/senseability/time/_time.d 


# Each subdirectory must supply rules for building sources it contributes
platforms/senseability/time/%.o: ../platforms/senseability/time/%.c
	@echo 'Building file: $<'
