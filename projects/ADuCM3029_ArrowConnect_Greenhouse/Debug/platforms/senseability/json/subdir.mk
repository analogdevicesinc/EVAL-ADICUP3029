...
C_SRCS += \
../platforms/senseability/json/telemetry.c 

SRC_OBJS += \
./platforms/senseability/json/telemetry.o 

C_DEPS += \
./platforms/senseability/json/telemetry.d 


# Each subdirectory must supply rules for building sources it contributes
platforms/senseability/json/%.o: ../platforms/senseability/json/%.c
	@echo 'Building file: $<'
