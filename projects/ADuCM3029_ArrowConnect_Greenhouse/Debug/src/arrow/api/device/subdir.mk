...
C_SRCS += \
../src/arrow/api/device/action.c \
../src/arrow/api/device/device.c \
../src/arrow/api/device/type.c 

SRC_OBJS += \
./src/arrow/api/device/action.o \
./src/arrow/api/device/device.o \
./src/arrow/api/device/type.o 

C_DEPS += \
./src/arrow/api/device/action.d \
./src/arrow/api/device/device.d \
./src/arrow/api/device/type.d 


# Each subdirectory must supply rules for building sources it contributes
src/arrow/api/device/%.o: ../src/arrow/api/device/%.c
	@echo 'Building file: $<'
